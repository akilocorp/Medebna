...
const renderSelectField = ({
  ...
  <div className="mb-6">
    ...
    <div className="relative">
      <select
        {...input}
        className="w-1/2 h-[44px] p-3 rounded-full bg-white text-[#6a6a6a] overflow-y-scroll focus:outline-none focus:ring-2 focus:ring-[#ff914d] focus:border-transparent shadow-md"
      >
        {children}
      </select>
      {touched && error && <span className="text-red-500 text-sm mt-1 block">{error}</span>}
